...
// fn fake_meta_info(data: &FakeData, tracker_url: Url) -> MetaInfo {
...
// fn test(data: Arc<FakeData>, peer_pieces_haves: Vec<PiecesHave>) {
//     // Create torrent file to download the data.
//     let meta_info = Arc::new(fake_meta_info(
//         &data,
//         Url::parse(&mockito::server_url()).unwrap(),
//     ));
//     let mut torrent_file = tempfile::NamedTempFile::new().unwrap();
//     torrent_file
//         .write_all(&meta_info.to_bencode().encode())
//         .unwrap();
...
//         let mut fake_peer = FakePeer::new(meta_info.clone(), data.clone(), pieces_have);
...
//             simple_torrent::run(opts.clone()).unwrap();
//         });
//     } else {
//         simple_torrent::run(opts.clone()).unwrap();
//     }
//     for fake_peer_fut in fake_peer_futs {
//         fake_peer_fut.unwrap();
//     }
...
// #[cfg(test)]
// #[test]
// fn test_torrent_one_fake_peer_singlefile() {
//     test(
...
// #[cfg(test)]
// #[test]
// fn test_torrent_one_fake_peer_multifile() {
//     test(
...
// #[cfg(test)]
// #[test]
// fn test_torrent_many_fake_peers() {
//     test(
...
// #[cfg(test)]
// #[test]
// fn test_torrent_many_fake_peers_leecher() {
//     test(
